  ...
  return (
    <div className="group border-b last:border-b-0 p-6 transition-colors hover:bg-muted/20">
      <div className="flex gap-5">
        {/* Logo */}
        <div className="flex h-12 w-12 shrink-0 items-center justify-center border bg-purple-50 border-purple-200 text-purple-700 text-sm font-semibold">
          {job.logo ? (
            <img
              src={job.logo}
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="mt-1 flex items-center gap-2">
                ...
                <span className="text-xs text-purple-600">• Glassdoor</span>
              </div>
            </div>
