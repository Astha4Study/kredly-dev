...
const ThreadRoot: FC<{ isEmpty: boolean }> = ({ isEmpty }) => {
  ...
  return (
    <ThreadPrimitive.Root
      className="aui-root aui-thread-root bg-zinc-100/50 @container flex h-full flex-col"
      style={{
      ...
      >
        ...
        >
          ...
          <ThreadPrimitive.ViewportFooter
            className={cn(
              "aui-thread-viewport-footer bg-zinc-100/50 flex flex-col gap-4 overflow-visible pb-4 md:pb-6",
              !isEmpty &&
